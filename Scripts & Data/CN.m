...
%% Read Range Data
load('Elevation10_1s'); load('Elevation20_1s'); load('Elevation30_1s')                          % Load data

t10 = Elevation10_1s(:,1); t20 = Elevation20_1s(:,1); t30 = Elevation30_1s(:,1);                % Access duration data [s]
d10 = Elevation10_1s(:,2)*1000; d20 = Elevation20_1s(:,2)*1000; d30 = Elevation30_1s(:,2)*1000; % Distance-to-Station Access data [m]

%% Compute/Read Access Time Data
load('t_Elevation10'); load('t_Elevation20'); load('t_Elevation30')

% Compute average access time for each minimum elevation studied
...
%% Plot histogram
plot_histogram(t_Elevation10,t_Elevation20,t_Elevation30)   
...
DL_16APSK = (B*1E-6*av_access_time_e10*60*eff(8))/8;    %Downlinked data for minimun elevation of 10º and without ACM
